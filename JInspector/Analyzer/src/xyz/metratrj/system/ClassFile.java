...
public class ClassFile {
    ...
    private int minior_version;
    private int major_version;
    private int constant_pool_count;
    private cp_info[] constant_pool;
    private int acces_flags;
    private int this_class;
    private int super_class;
    private int interfaces_count;
    private CONSTANT_Class_info[] interfaces;
    private int fields_count;
    private field_info[] field_info_fields;
    private int method_count;
    private method_info[] method_info_methods;
    private int attributes_count;
    private attribute_info[] attribute_info_attributes;


    public static ClassFile parse(Path path) throws IOException {
        DataInputStream in = new DataInputStream(new FileInputStream(path.toString()));
        try {
            ...
            return new ClassFile(magic, minor, major, cpCount, cpPool, access_flags, this_class, super_class, interfaces_count, interfaces, fields_count, fields, methods_count, methods, attributes_count, attributes);
        } finally {
            in.close();
        }
    }
    ...
    public ClassFile(long magic,
                     ...
                     int method_count,
                     method_info[] method_info_methods,
                     int attributes_count,
                     attribute_info[] attribute_info_attributes) {
        super();
        this.magic = magic;
        this.minior_version = minior_version;
        ...
        this.field_info_fields = field_info_fields;
        this.method_count = method_count;
        this.method_info_methods = method_info_methods;
        this.attributes_count = attributes_count;
        this.attribute_info_attributes = attribute_info_attributes;
    }
}
